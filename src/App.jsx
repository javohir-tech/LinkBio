    ...
    <>
      <div className=' rounded box'>
        ...
        <div className='bio-btns d-flex flex-column flex-md-row justify-content-center'>
          ...
          <a target='_blank' href="https://github.com/javohir-tech" className='btn btn-dark d-flex align-items-center'><FaGithub style={{ color: "white" }} /><p className='mb-0 ms-1'>Email</p></a>
        </div>
